                            ...
                            cryptoData.map((data, index) => {
                                return (
                                    <tr key={index} className='text-center text-base border-b border-gray-100 hover:bg-gray-200 last:border-b-0'>
                                        ...
                                        <td className='py-4'>{new Intl.NumberFormat('en-JP', { style: 'currency', currency: 'USD'}).format(data.current_price)}</td>
                                        <td className='py-4'>{new Intl.NumberFormat('en-JP', { style: 'currency', currency: 'USD'}).format(data.market_cap)}</td>
                                        <td className='py-4'>{new Intl.NumberFormat('en-JP', { style: 'currency', currency: 'USD'}).format(data.high_24h)}</td>
                                        <td className={
