...
const TableComponent = () => {
    ...
    return (
        <>
            <div
                className='flex flex-col mt-9 border-2 border-gray-100 rounded-md overflow-auto min-h-screen sticky left-0'
            >
                {
                                ...
                                cryptoData.map((data, index) => {
                                    return (
                                        <tr key={index} className='text-center text-sm md:text-base border-b border-gray-100 hover:bg-gray-200 last:border-b-0'>
                                            ...
                                            <td className='py-4'>{new Intl.NumberFormat('en-US', { style: 'currency', currency: currency }).format(data.market_cap)}</td>
